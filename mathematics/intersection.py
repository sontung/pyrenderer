...
def triangle_ray_intersection_grouping(ray, nb_triangles, s_array, q_array, r_array, p0_array,
    ...
    # print(u1.shape, u2.shape, nb_triangles, s_array.shape, q_array.shape, r_array.shape, p0_array.shape, e1_array.shape,
    #       e2_array.shape, a_array.shape, e2r_array.shape, sq_array.shape, rdr_array.shape, res_holder)
